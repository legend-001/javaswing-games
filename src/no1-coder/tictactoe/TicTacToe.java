...
public class TicTacToe extends JFrame implements ActionListener{
	...
	JLabel radioLabel;
	boolean compFlag, newGameFlag;					//compFlag is set true when user selects to play against the computer
	JPanel centerWrapper, northWrapper, southWrapper;
	...
	Player player1, player2, playerCPU, currentPlayer;
	...
	public TicTacToe() {
		...
		Image xoIcon = Toolkit.getDefaultToolkit().getImage("src\\resources\\xoxo-icon.png").getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	...
	public void addLabels() {					//Adding the top and bottom panels
